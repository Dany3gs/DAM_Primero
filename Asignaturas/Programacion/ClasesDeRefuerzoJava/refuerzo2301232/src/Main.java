 ...
 * Un contacto está definido por un nombre y un teléfono (No es necesario
 * de validar). Un contacto es igual a otro cuando sus nombres son iguales.
 * Una agenda de contactos está formada por un conjunto de contactos
 * (Piensa en que tipo puede ser)
 ...
 * a la agenda se indicará por pantalla.
 * No se pueden meter contactos que existan, es decir, no podemos duplicar nombres,
